#The solution to the game show problem

from tkinter import *
import pygame.mixer

#I think these functions are first because they are now handlers
...
num_good = IntVar()
num_good.set(0) #I think this is the same as correct_s = 0
num_bad = IntVar()
num_bad.set(0)# I think this is the same as wrong_s = 0

lab = Label(app, text='When you are ready, click on the buttons!', height=3)
lab.pack() #use label instead of printing the text
